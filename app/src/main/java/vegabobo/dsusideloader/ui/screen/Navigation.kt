...
import vegabobo.dsusideloader.ui.gsiEditor.GsiEditorScreen
...
object Destinations {
    ...
    const val GsiEditor = "gsi_editor"
    const val Up = "up"
}
...
fun Navigation() {
    ...
    NavHost(navController = navController, startDestination = Destinations.Homepage) {
        ...
        composable(Destinations.GsiEditor) { GsiEditorScreen(navigate = { navigate(it) }) }
    }
}